...
; Numbered IRQ handler vectors				
                ...
                DCD     CLKGEN_RTC_IRQHandler		; IRQ #2
                ...
                DCD     GPIO_IRQHandler		; IRQ #12
                DCD     CTIMER_IRQHandler		; IRQ #13
                DCD     UART0_IRQHandler		; IRQ #14
                DCD     UART1_IRQHandler		; IRQ #15
                DCD     ADC_IRQHandler		; IRQ #16
                DCD     PDM_IRQHandler		; IRQ #17
                DCD     STIMER_IRQHandler		; IRQ #18
                DCD     STIMER_CMPR0_IRQHandler		; IRQ #19
                DCD     STIMER_CMPR1_IRQHandler		; IRQ #20
                DCD     STIMER_CMPR2_IRQHandler		; IRQ #21
                DCD     STIMER_CMPR3_IRQHandler		; IRQ #22
                DCD     STIMER_CMPR4_IRQHandler		; IRQ #23
                DCD     STIMER_CMPR5_IRQHandler		; IRQ #24
                DCD     STIMER_CMPR6_IRQHandler		; IRQ #25
                DCD     STIMER_CMPR7_IRQHandler		; IRQ #26
...
Default_Handler PROC
                ...
                EXPORT  CLKGEN_RTC_IRQHandler    [WEAK]
...
CLKGEN_RTC_IRQHandler		; 2  CLKGEN_RTC                                                             
...
GPIO_IRQHandler		; 12 GPIO                                                                   
CTIMER_IRQHandler		; 13 CTIMER                                                                 
UART0_IRQHandler		; 14 UART0                                                                  
UART1_IRQHandler		; 15 UART1                                                                  
ADC_IRQHandler		; 16 ADC                                                                    
PDM_IRQHandler		; 17 PDM                                                                    
STIMER_IRQHandler		; 18 STIMER                                                                 
STIMER_CMPR0_IRQHandler		; 19 STIMER_CMPR0                                                           
STIMER_CMPR1_IRQHandler		; 20 STIMER_CMPR1                                                           
STIMER_CMPR2_IRQHandler		; 21 STIMER_CMPR2                                                           
STIMER_CMPR3_IRQHandler		; 22 STIMER_CMPR3                                                           
STIMER_CMPR4_IRQHandler		; 23 STIMER_CMPR4                                                           
STIMER_CMPR5_IRQHandler		; 24 STIMER_CMPR5                                                           
STIMER_CMPR6_IRQHandler		; 25 STIMER_CMPR6                                                           
STIMER_CMPR7_IRQHandler		; 26 STIMER_CMPR7                                                           

...
/*****************************************************************************/
#define RTE_DEVICE_AMAPH1KK_KCR 2
#define RTE_DEVICE_AMAPH1KK_KBR 1
      
#warning Please select your device here or in the compiler defines section (default set):
#define RTE_DEVICE_SELECTION RTE_DEVICE_AMAPH1KK_KCR

//Defines for AMAPH1KK_KBR
#if RTE_DEVICE_SELECTION == RTE_DEVICE_AMAPH1KK_KBR
    #if !defined(APOLLO2_1024)
        #define APOLLO2_1024
    #endif /* end APOLLO2_1024*/
#endif
...
//Defines for AMAPH1KK_KCR
#if RTE_DEVICE_SELECTION == RTE_DEVICE_AMAPH1KK_KCR
    #if !defined(APOLLO2_1024)
        #define APOLLO2_1024
    #endif /* end APOLLO2_1024*/
#endif
